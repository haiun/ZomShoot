#ifndef ZOMBIE_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define ZOMBIE_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
...
VertexOutputBaseSimple vertZombieForwardBaseSimple (VertexInput v)
{
...
FragmentCommonData FragmentSetupSimple(VertexOutputBaseSimple i)
{
    ...
    half alpha = Alpha(i.tex.xy) * (_BurnningAlpha < 1-i.tex.y ? 0 : 1);	//ZOMBIE
...
half4 fragZombieForwardBaseSimpleInternal (VertexOutputBaseSimple i)
{
...
{
    return fragZombieForwardBaseSimpleInternal(i);
}
...
VertexOutputForwardAddSimple vertZombieForwardAddSimple (VertexInput v)
{
...
half4 fragZombieForwardAddSimpleInternal (VertexOutputForwardAddSimple i)
{
    UNITY_APPLY_DITHER_CROSSFADE(i.pos.xy);
...
{
    return fragZombieForwardAddSimpleInternal(i);
}

#endif // ZOMBIE_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
