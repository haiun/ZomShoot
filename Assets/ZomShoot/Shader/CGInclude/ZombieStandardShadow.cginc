...
// otherwise compiler gives trouble with LIGHTING_COORDS macro (in ZombieStandardCore.cginc)
...
) : SV_Target
{
            ...
            half alpha = tex2D(_MainTex, i.tex.xy).a * _Color.a * (_BurnningAlpha < 1-i.tex.y ? 0 : 1);	//ZOMBIE
        #endif
